    ...
    Column(
        ...
        ElevatedCard(
            ...
            Box(
                ...
                InformationTooltip(
                    richTooltipSubheadText = "Adding Income Transaction",
                    richTooltipText = "Add the amount of the income transaction. You can input a title and description (E.G. For my savings account, From salary) ",
